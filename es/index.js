...
var ContextChart = function (_a) {
    ...
    return (jsxs(Fragment, { children: [renderXAxis(AXIS_PLACEMENTS.TOP, xAxis, { xAxisPlacement: xAxisPlacement }), jsxs("svg", { height: height, width: width, style: { width: '100%', display: 'block' }, children: [annotations, jsx(LineCollection$1, { series: series.map(function (s) { return (__assign(__assign({}, s), { drawPoints: false })); }), width: width, height: height, yScalerFactory: getYScale, scaleY: false, scaleX: false, subDomainsByItemId: subDomainsByItemId }), jsx(Brush, { width: width, height: height, selection: selection, onUpdateSelection: function (newSelection) {
