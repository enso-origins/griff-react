...
var ContextChart = function (_a) {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [renderXAxis(AXIS_PLACEMENTS.TOP, xAxis, { xAxisPlacement: xAxisPlacement }), jsxRuntime.jsxs("svg", { height: height, width: width, style: { width: '100%', display: 'block' }, children: [annotations, jsxRuntime.jsx(LineCollection$1, { series: series.map(function (s) { return (tslib.__assign(tslib.__assign({}, s), { drawPoints: false })); }), width: width, height: height, yScalerFactory: getYScale, scaleY: false, scaleX: false, subDomainsByItemId: subDomainsByItemId }), jsxRuntime.jsx(Brush, { width: width, height: height, selection: selection, onUpdateSelection: function (newSelection) {
