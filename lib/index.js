    ...
    function DataProvider(props) {
        ...
        _this.renderLegacyItems = function () {
            ...
            if (series || collections) {
                return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [(series || []).map(function (s) { return (jsxRuntime.jsx(Series$1, tslib.__assign({}, s), s.id)); }), (collections || []).map(function (c) { return (jsxRuntime.jsx(Collection$1, tslib.__assign({}, c), c.id)); })] }));
            }
            return null;
        };
