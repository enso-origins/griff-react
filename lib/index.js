...
var Brush = /** @class */ (function (_super) {
    ...
    Brush.prototype.render = function () {
        ...
        return (jsxRuntime.jsxs("g", { fill: "none", stroke: "#777", onMouseMove: this.onMouseMove, children: [jsxRuntime.jsx("rect", { className: "before-selection", fill: outsideColor, fillOpacity: 0.3, stroke: "#fff", shapeRendering: "crispEdges", width: Math.max(0, selection[0]), height: height, x: 0, y: 0 }), jsxRuntime.jsx("rect", { className: "after-selection", fill: outsideColor, fillOpacity: 0.3, stroke: "#fff", shapeRendering: "crispEdges", width: Math.max(0, width - selection[1]), height: height, x: selection[1], y: 0 }), jsxRuntime.jsx("rect", { className: "overlay", pointerEvents: "all", cursor: disabledCursor || 'crosshair', x: 0, y: 0, fill: "none", width: width, height: height, onMouseDown: this.onMouseDownOverlay }), jsxRuntime.jsx("rect", { className: "selection", cursor: disabledCursor || 'move', fill: selectionColor, fillOpacity: 0.3, pointerEvents: "all", shapeRendering: "crispEdges", width: selectionWidth, height: height, x: selection[0], y: 0, onMouseDown: this.onMouseDownSelection }), jsxRuntime.jsx("path", { className: "handle handle--west", stroke: handleColor, strokeWidth: handleWidth, d: "M ".concat(selection[0], " 0 V ").concat(height) }), jsxRuntime.jsx("rect", { className: "handle-target handle-target--west", cursor: disabledCursor || 'ew-resize', x: selection[0] - handleTargetWidth / 2, y: 0, width: handleTargetWidth, height: height, fill: "none", pointerEvents: "all", stroke: "none", onMouseDown: this.onMouseDownHandleWest }), jsxRuntime.jsx("circle", { className: "handle-target handle-target--west", cursor: disabledCursor || 'ew-resize', stroke: handleColor, fill: handleColor, strokeWidth: handleWidth, cx: selection[0] - handleTargetWidth / 2 + 4, cy: height / 4, r: 8, pointerEvents: "all", onMouseDown: this.onMouseDownHandleWest }), jsxRuntime.jsx("circle", { className: "handle-target handle-target--east", cursor: disabledCursor || 'ew-resize', stroke: handleColor, fill: handleColor, strokeWidth: handleWidth, cx: selection[1] - handleTargetWidth / 2 + 4, cy: height / 4, r: 8, pointerEvents: "all", onMouseDown: this.onMouseDownHandleEast }), jsxRuntime.jsx("path", { className: "handle handle--east", stroke: handleColor, strokeWidth: handleWidth, d: "M ".concat(selection[1], " 0 V ").concat(height) }), jsxRuntime.jsx("rect", { className: "handle-target handle-target--east", cursor: disabledCursor || 'ew-resize', x: selection[1] - handleTargetWidth / 2, y: 0, width: handleTargetWidth, height: height, fill: "none", pointerEvents: "all", stroke: "none", onMouseDown: this.onMouseDownHandleEast })] }));
    };
    return Brush;
}(React__default.Component));

var DataContext = React__default.createContext({
    series: [],
    collections: [],
    ...
    registerSeries: function () {
        ...
        return console.log.apply(console, tslib.__spreadArray(['Fake-registering series:'], args, false));
    },
});
...
var Series = function (_a) {
    ...
    props = tslib.__rest(_a, ["id", "registerSeries", "updateSeries"]);
    // This only happens once, when the component is first mounted.
    React__default.useEffect(function () {
        return registerSeries(tslib.__assign({ id: id }, props));
    }, []);
    // But whenever the component is updated, we want to update the series in the
    // DataProvider.
    React__default.useEffect(function () {
        return updateSeries(tslib.__assign({ id: id }, props));
...
var Series$1 = withDisplayName('Series', function (props) { return (jsxRuntime.jsx(DataContext.Consumer, { children: function (_a) {
        var registerSeries = _a.registerSeries, updateSeries = _a.updateSeries;
        return (jsxRuntime.jsx(Series, tslib.__assign({}, props, { registerSeries: registerSeries, updateSeries: updateSeries })));
    } })); });

// @ts-ignore - I don't know how to make TypeScript happy about ...props
var Collection = function (_a) {
    var id = _a.id, registerCollection = _a.registerCollection, updateCollection = _a.updateCollection, children = _a.children, props = tslib.__rest(_a, ["id", "registerCollection", "updateCollection", "children"]);
    React__default.useEffect(function () {
        return registerCollection(tslib.__assign({ id: id }, props));
    }, []);
    React__default.useEffect(function () {
        return updateCollection(tslib.__assign({ id: id }, props));
    }, 
    // @ts-ignore - It's okay for props[name] to be implicit any.
...
var Collection$1 = withDisplayName('Collection', function (props) { return (jsxRuntime.jsx(DataContext.Consumer, { children: function (_a) {
        var registerCollection = _a.registerCollection, updateCollection = _a.updateCollection;
        return (jsxRuntime.jsx(Collection, tslib.__assign({ registerCollection: registerCollection, updateCollection: updateCollection }, props, { children: props.children })));
    } })); });

var ScalerContext = React__default.createContext({
    series: [],
    collections: [],
    domainsByItemId: {},
    subDomainsByItemId: {},
...
var Points = function (_a) {
    ...
    var points = data.filter(pointFilter).map(function (d, i, arr) {
        ...
        if (!Number.isNaN(x0) && !Number.isNaN(x1)) {
            uiElements.push(jsxRuntime.jsx("line", { x1: x0, y1: y, x2: x1, y2: y, stroke: color, strokeWidth: 1 }, "horizontal-".concat(x0, ",").concat(y, "-").concat(x1, ",").concat(y)));
        }
        if (!Number.isNaN(y0) && !Number.isNaN(y1)) {
            uiElements.push(jsxRuntime.jsx("line", { x1: x, y1: y0, x2: x, y2: y1, stroke: color, strokeWidth: 1 }, "vertical-".concat(x, ",").concat(y0, "-").concat(x, ",").concat(y1)));
        }
        if (!Number.isNaN(x) && !Number.isNaN(y)) {
            uiElements.push(jsxRuntime.jsx("circle", { className: "point", r: width / 2, opacity: opacityAccessor ? opacityAccessor(d, i, arr) : opacity, cx: x, cy: y, fill: color }, "".concat(x, "-").concat(y)));
        }
    ...
    return jsxRuntime.jsx("g", { children: points });
};
...
var Line = function (_a) {
    ...
    var area;
    var curve = step ? d3.curveStepAfter : d3.curveLinear;
    var line = d3.line()
        .curve(curve)
        .x(function (d) {
    ...
    if (drawPoints) {
        ...
        circles = (jsxRuntime.jsx(Points, { data: data.filter(function (d) {
    ...
    return (jsxRuntime.jsxs("g", { clipPath: "url(#".concat(clipPath, ")"), children: [area && (jsxRuntime.jsx("path", { className: "line-area", d: area(
                // @ts-ignore - I'm pretty sure that d3 has the wrong type annotations.
                data), style: {
                    stroke: color,
                    strokeOpacity: 0,
                ...
                } })), jsxRuntime.jsx("path", { "data-testid": "Line-".concat(id), className: "line", d: line(
                // @ts-ignore - I'm pretty sure that d3 has the wrong type annotations.
                data), style: {
                    stroke: color,
                    strokeWidth: "".concat(strokeWidth, "px"),
...
var LineCollection = function (_a) {
    ...
    var lines = series.reduce(function (l, s) {
        ...
        return tslib.__spreadArray(tslib.__spreadArray([], l, true), [
            jsxRuntime.jsx(Line, tslib.__assign({}, s, { xAxisAccessor: xAxis === AXES.time ? s.timeAccessor : s.xAccessor, xScale: xScale, yScale: yScale, clipPath: clipPath, pointWidth: s.pointWidth || pointWidth }), s.id),
        ], false);
    }, new Array());
    return (jsxRuntime.jsxs("g", { width: width, height: height, children: [jsxRuntime.jsx("clipPath", { id: clipPath, children: jsxRuntime.jsx("rect", { width: width, height: height, fill: "none" }) }), lines] }));
};
var LineCollection$1 = withDisplayName('LineCollection', function (props) { return (jsxRuntime.jsx(ScalerContext.Consumer, { children: function (_a) {
        var domainsByItemId = _a.domainsByItemId, subDomainsByItemId = _a.subDomainsByItemId, series = _a.series;
        return (jsxRuntime.jsx(LineCollection, tslib.__assign({ series: series }, props, { domainsByItemId: domainsByItemId, subDomainsByItemId: subDomainsByItemId })));
    } })); });
...
var ZoomRect = /** @class */ (function (_super) {
    tslib.__extends(ZoomRect, _super);
    function ZoomRect() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        ...
        _this.performTouchDrag = function (touches, totalDistances) {
            ...
            _this.lastTouch = tslib.__assign({}, newTouchPosition);
            return updates;
        };
        _this.performTouchZoom = function (touches, totalDistances) {
            ...
            _this.lastDeltas = tslib.__assign({}, deltas);
            return updates;
        };
    ...
    ZoomRect.prototype.render = function () {
        ...
        return (jsxRuntime.jsx("rect", { ref: function (ref) {
                _this.zoomNode = ref;
...
var ZoomRect$1 = withDisplayName('ZoomRect', function (props) { return (jsxRuntime.jsx(ScalerContext.Consumer, { children: function (_a) {
        var domainsByItemId = _a.domainsByItemId, subDomainsByItemId = _a.subDomainsByItemId, updateDomains = _a.updateDomains;
        return (jsxRuntime.jsx(ZoomRect, tslib.__assign({}, props, { domainsByItemId: domainsByItemId, subDomainsByItemId: subDomainsByItemId, updateDomains: updateDomains })));
    } })); });
...
var XAxis = function (_a) {
    ...
    var textProps = tslib.__assign({ fill: stroke, dy: '0.71em' }, getTextProps({
        height: height,
        placement: placement,
        strokeWidth: strokeWidth,
    ...
    var axisElement = (jsxRuntime.jsxs("g", { "data-testid": "xAxis", className: "axis x-axis", fill: "none", fontSize: tickFontSize, textAnchor: "middle", strokeWidth: strokeWidth, children: [jsxRuntime.jsx("path", { stroke: stroke, d: pathString }), values.map(function (v) {
                var lineProps = tslib.__assign({ stroke: stroke }, getLineProps({
                    height: height,
                    placement: placement,
                    strokeWidth: strokeWidth,
                    tickSizeInner: tickSizeInner,
                }));
                return (jsxRuntime.jsxs("g", { opacity: 1, transform: tickTransformer(scale(v)), children: [jsxRuntime.jsx("line", tslib.__assign({ stroke: stroke }, lineProps)), jsxRuntime.jsx("text", tslib.__assign({ className: "tick-value" }, textProps, { children: tickFormatter(+v, values) }))] }, +v));
            })] }));
    return (jsxRuntime.jsxs("svg", { width: width, style: { width: '100%', display: 'block' }, height: height, children: [axisElement, jsxRuntime.jsx(ZoomRect$1, { width: width, height: height, itemIds: series.filter(function (s) { return !s.hidden; }).map(function (s) { return s.id; }), zoomAxes: (_b = {}, _b[a] = true, _b) })] }));
};
var SizedXAxis = function (props) {
    var _a = reactResizeDetector.useResizeDetector(), ref = _a.ref, width = _a.width;
    return (jsxRuntime.jsx("div", { ref: ref, style: { width: '100%' }, children: jsxRuntime.jsx(XAxis, tslib.__assign({}, props, { width: props.width !== undefined ? props.width : width || undefined })) }));
};
var XAxis$1 = withDisplayName('XAxis', function (props) { return (jsxRuntime.jsx(ScalerContext.Consumer, { children: function (_a) {
        var domainsByItemId = _a.domainsByItemId, subDomainsByItemId = _a.subDomainsByItemId, series = _a.series;
        return (jsxRuntime.jsx(SizedXAxis, tslib.__assign({ series: series }, props, { domainsByItemId: domainsByItemId, subDomainsByItemId: subDomainsByItemId })));
    } })); });
...
var Annotation = function (_a) {
    ...
    return (jsxRuntime.jsx("rect", { className: "griff-annotation griff-annotation-".concat(id), x: xScale(data[0]), y: 0, height: height, width: xScale(data[1]) - xScale(data[0]), style: { stroke: color, fill: color, fillOpacity: fillOpacity } }, id));
};
...
var formatDay = d3.timeFormat('%d/%m');
var formatWeek = d3.timeFormat('%d/%m');
var formatMonth = d3.timeFormat('%d/%m');
...
var findItemsWithChangedDomains = function (previousItems, currentItems) {
    var previousItemsById = previousItems.reduce(function (acc, s) {
        var _a;
        return (tslib.__assign(tslib.__assign({}, acc), (_a = {}, _a[s.id] = s, _a)));
    }, {});
    return currentItems.reduce(function (acc, s) {
        if (!previousItemsById[s.id] ||
            haveDomainsChanged(previousItemsById[s.id], s)) {
            return tslib.__spreadArray(tslib.__spreadArray([], acc, true), [s], false);
        }
        return acc;
    }, []);
};
...
var firstResolvedDomain = function (domain) {
    ...
    if (domain && domain.placeholder !== true) {
        return tslib.__spreadArray([], domain, true);
    }
    if (domains.length === 0) {
        return undefined;
    }
    return firstResolvedDomain.apply(void 0, tslib.__spreadArray([domains[0]], domains.splice(1), false));
};
/**
...
var Scaler = /** @class */ (function (_super) {
    ...
    function Scaler() {
        ...
        _this.updateDomains = function (changedDomainsById, callback) {
            ...
            var newSubDomains = tslib.__assign({}, subDomainsByItemId);
            Object.keys(changedDomainsById).forEach(function (itemId) {
                newSubDomains[itemId] = tslib.__assign({}, (subDomainsByItemId[itemId] || {}));
    ...
    Scaler.getDerivedStateFromProps = function (_a, state) {
        ...
        var stateUpdates = series.concat(collections).reduce(function (acc, item) {
            var _a, _b;
            var updates = tslib.__assign({}, acc);
            if (!domainsByItemId[item.id]) {
                updated = true;
                updates.domainsByItemId = tslib.__assign(tslib.__assign({}, updates.domainsByItemId), (_a = {}, _a[item.id] = {
                    time: tslib.__spreadArray([], timeDomain, true),
            ...
            if (!subDomainsByItemId[item.id]) {
                updated = true;
                updates.subDomainsByItemId = tslib.__assign(tslib.__assign({}, updates.subDomainsByItemId), (_b = {}, _b[item.id] = {
                    time: tslib.__spreadArray([], timeSubDomain, true),
    ...
    Scaler.prototype.componentDidUpdate = function (prevProps) {
        ...
        if (changedSeries.length > 0 || changedCollections.length > 0) {
            var domainsByItemId_1 = tslib.__assign({}, oldDomainsByItemId);
            var subDomainsByItemId_1 = tslib.__assign({}, oldSubDomainsByItemId);
            tslib.__spreadArray(tslib.__spreadArray([], changedSeries, true), changedCollections, true).forEach(function (item) {
        ...
        if (!isEqual(prevProps.dataContext.timeSubDomain, dataContext.timeSubDomain)) {
            ...
            Object.keys(oldSubDomainsByItemId).forEach(function (itemId) {
                newSubDomainsByItemId_1[itemId] = tslib.__assign(tslib.__assign({}, oldSubDomainsByItemId[itemId]), { time: dataContext.timeSubDomain });
            });
            // eslint-disable-next-line react/no-did-update-set-state
    ...
    Scaler.prototype.render = function () {
        ...
        return (jsxRuntime.jsx(ScalerContext.Provider, { value: finalContext, children: children }));
    };
...
var Scaler$1 = withDisplayName('Scaler', function (props) { return (jsxRuntime.jsx(DataContext.Consumer, { children: function (dataContext) { return (jsxRuntime.jsx(Scaler, tslib.__assign({}, props, { dataContext: dataContext }))); } })); });
...
var calculateDomainFromData = function (data, accessor, minAccessor, maxAccessor) {
    ...
    if (Math.abs(diff) < 1e-3) {
        ...
        var domain = [(1 / 2) * extent[0], (3 / 2) * extent[0]];
...
var deleteUndefinedFromObject = function (obj) {
    ...
    return Object.keys(obj).reduce(function (acc, k) {
        var _a;
        if (obj[k] !== undefined) {
            return tslib.__assign(tslib.__assign({}, acc), (_a = {}, _a[k] = obj[k], _a));
        }
        return acc;
    }, {});
};
...
var DataProvider = /** @class */ (function (_super) {
    tslib.__extends(DataProvider, _super);
    function DataProvider(props) {
        ...
        _this.getSeriesObjects = function () {
            ...
            return Object.keys(seriesById).reduce(function (acc, id) {
                ...
                var collection = series.collectionId !== undefined
                    ...
                    : {};
                var completedSeries = tslib.__assign(tslib.__assign(tslib.__assign(tslib.__assign(tslib.__assign({}, DEFAULT_SERIES_CONFIG), dataProvider), { 
                ...
                return tslib.__spreadArray(tslib.__spreadArray([], acc, true), [completedSeries], false);
            }, []);
        };
        ...
        _this.fetchData = function (id, reason) { return tslib.__awaiter(_this, void 0, void 0, function () {
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        params = {
                            ...
                            oldSeries: tslib.__assign({ data: [] }, seriesObject),
                            reason: reason,
                        };
                        _c.label = 1;
                    case 1:
                    ...
                    case 4:
                        this.setState(function (_a) {
                            ...
                            var stateUpdates = {};
                            var series = tslib.__assign(tslib.__assign({}, freshSeries), loaderResult);
                            if (
                            ...
                            reason === 'MOUNTED' ||
                                ...
                                var collection = series.collectionId
                                    ? collectionsById[series.collectionId] || {}
                                    : {};
                                stateUpdates.timeSubDomains = tslib.__assign(tslib.__assign({}, freshTimeSubDomains), (_b = {}, _b[id] = calculateDomainFromData(series.data, series.timeAccessor || timeAccessor || DEFAULT_ACCESSORS.time), _b));
                                stateUpdates.xSubDomains = tslib.__assign(tslib.__assign({}, freshXSubDomains), (_c = {}, _c[id] = calculateDomainFromData(series.data, series.xAccessor ||
                                ...
                                stateUpdates.ySubDomains = tslib.__assign(tslib.__assign({}, freshYSubDomains), (_d = {}, _d[id] = calculateDomainFromData(series.data, series.yAccessor ||
                            ...
                            stateUpdates.seriesById = tslib.__assign(tslib.__assign({}, freshSeriesById), (_e = {}, _e[id] = series, _e));
                            return stateUpdates;
                        }, function () {
                            var _a = _this.state, _b = id, series = _a.seriesById[_b];
                            onFetchData(tslib.__assign({}, series));
                        });
                        return [2 /*return*/];
                }
            });
        ...
        _this.registerCollection = function (_a) {
            var id = _a.id, collection = tslib.__rest(_a, ["id"]);
            _this.setState(function (_a) {
                var _b;
                var collectionsById = _a.collectionsById;
                return ({
                    collectionsById: tslib.__assign(tslib.__assign({}, collectionsById), (_b = {}, _b[id] = deleteUndefinedFromObject(tslib.__assign(tslib.__assign({}, collection), { id: id })), _b)),
                });
            });
            ...
            return function () {
                _this.setState(function (_a) {
                    var collectionsById = _a.collectionsById;
                    var copy = tslib.__assign({}, collectionsById);
                    delete copy[id];
                    return {
        ...
        _this.updateCollection = function (_a) {
            ...
            _this.setState(function (_a) {
                ...
                var collectionsById = _a.collectionsById;
                return ({
                    collectionsById: tslib.__assign(tslib.__assign({}, collectionsById), (_b = {}, _b[id] = deleteUndefinedFromObject(tslib.__assign(tslib.__assign(tslib.__assign({}, collectionsById[id]), collection), { id: id })), _b)),
                });
            });
        };
        _this.registerSeries = function (_a) {
            var id = _a.id, series = tslib.__rest(_a, ["id"]);
            _this.setState(function (_a) {
                var _b;
                var seriesById = _a.seriesById;
                return ({
                    seriesById: tslib.__assign(tslib.__assign({}, seriesById), (_b = {}, _b[id] = deleteUndefinedFromObject(tslib.__assign(tslib.__assign({}, series), { id: id })), _b)),
                });
            }, function () {
            ...
            return function () {
                _this.setState(function (_a) {
                    var seriesById = _a.seriesById;
                    var copy = tslib.__assign({}, seriesById);
                    delete copy[id];
                    return {
                        seriesById: copy,
                    };
        ...
        _this.updateSeries = function (_a) {
            ...
            _this.setState(function (_a) {
                ...
                var seriesById = _a.seriesById;
                return ({
                    seriesById: tslib.__assign(tslib.__assign({}, seriesById), (_b = {}, _b[id] = deleteUndefinedFromObject(tslib.__assign(tslib.__assign(tslib.__assign({}, seriesById[id]), series), { id: id })), _b)),
                });
            });
        };
        ...
        _this.renderLegacyItems = function () {
            ...
            if (series || collections) {
                return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [(series || []).map(function (_a) {
                            var _k = _a.key, s = tslib.__rest(_a, ["key"]);
                            return (jsxRuntime.jsx(Series$1, tslib.__assign({}, s), s.id));
                        }), (collections || []).map(function (_a) {
                            var _k = _a.key, c = tslib.__rest(_a, ["key"]);
                            return (jsxRuntime.jsx(Collection$1, tslib.__assign({}, c), c.id));
                        })] }));
            }
            return null;
        };
    ...
    DataProvider.prototype.render = function () {
        ...
        var domainsByCollectionId = seriesObjects.reduce(function (acc, series) {
            ...
            return tslib.__assign(tslib.__assign({}, acc), (_a = {}, _a[collectionId] = {
        ...
        var collectionsWithDomains = Object.keys(collectionsById).reduce(function (acc, id) {
            ...
            return tslib.__spreadArray(tslib.__spreadArray([], acc, true), [
                tslib.__assign(tslib.__assign({}, collectionsById[id]), domainsByCollectionId[id]),
            ], false);
        }, []);
        ...
        return (jsxRuntime.jsxs(DataContext.Provider, { value: context, children: [this.renderLegacyItems(), jsxRuntime.jsx(Scaler$1, { children: children })] }));
    };
    return DataProvider;
}(React.Component));
...
var onUpdateSelection = function (selection, _a) {
    ...
    updateDomains(series.reduce(function (changes, s) {
        var _a;
        return (tslib.__assign(tslib.__assign({}, changes), (_a = {}, _a[s.id] = {
            time: timeSubDomain,
        }, _a)));
    }, {}));
};
...
var renderXAxis = function (position, xAxis, _a) {
    ...
    if (xAxisPlacement === AXIS_PLACEMENTS.BOTH) {
        return React__default.cloneElement(xAxis, { placement: position });
    }
    return null;
};
var ContextChart = function (_a) {
    ...
    var annotations = propsAnnotations.map(function (a) { return (jsxRuntime.jsx(Annotation, tslib.__assign({}, a, { height: height, xScale: xScale }), a.id)); });
    var xAxis = (jsxRuntime.jsx(XAxis$1, { height: xAxisHeight, domain: timeDomain, tickFormatter: xAxisFormatter, placement: xAxisPlacement, scaled: false, axis: AXES.time }));
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [renderXAxis(AXIS_PLACEMENTS.TOP, xAxis, { xAxisPlacement: xAxisPlacement }), jsxRuntime.jsxs("svg", { height: height / 2, width: width, style: { width: '100%', display: 'block' }, children: [annotations, jsxRuntime.jsx(LineCollection$1, { series: series.map(function (s) { return (tslib.__assign(tslib.__assign({}, s), { drawPoints: false, hidden: true })); }), width: width, height: height, yScalerFactory: getYScale, scaleY: false, scaleX: false, subDomainsByItemId: subDomainsByItemId }), jsxRuntime.jsx(Brush, { width: width, height: height, selection: selection, onUpdateSelection: function (newSelection) {
...
var SizedContextChart = function (_a) {
    var explicitWidth = _a.width, rest = tslib.__rest(_a, ["width"]);
    var _b = reactResizeDetector.useResizeDetector(), ref = _b.ref, width = _b.width;
    return (jsxRuntime.jsx("div", { ref: ref, style: { width: '100%' }, children: jsxRuntime.jsx(ContextChart, tslib.__assign({}, rest, { width: explicitWidth !== undefined ? explicitWidth : width || 1 })) }));
};
...
var ContextChart$1 = withDisplayName('ContextChart', function (props) { return (jsxRuntime.jsx(ScalerContext.Consumer, { children: function (_a) {
        ...
        return (jsxRuntime.jsx(SizedContextChart, tslib.__assign({}, props, { series: series, subDomainsByItemId: subDomainsByItemId, domainsByItemId: domainsByItemId, updateDomains: updateDomains })));
    } })); });
...
var GridLines = function (_a) {
    ...
    if (y) {
        if (y.seriesIds) {
            var seriesIdMap_1 = y.seriesIds.reduce(function (dict, id) {
                var _a;
                return (tslib.__assign(tslib.__assign({}, dict), (_a = {}, _a[id] = true, _a)));
            }, {});
            series
    ...
    if (x) {
        if (x.pixels) {
            for (var position = (width % x.pixels) / 2; position <= width; position += x.pixels) {
                lines.push(jsxRuntime.jsx("line", { className: "grid-line grid-line-vertical", y1: 0, y2: height, x1: position, x2: position, stroke: x.color || color, strokeWidth: x.strokeWidth || strokeWidth, opacity: x.opacity || opacity }, "vertical-".concat(position)));
            }
        }
            ...
            values.forEach(function (v) {
                lines.push(jsxRuntime.jsx("line", { className: "grid-line grid-line-vertical", opacity: x.opacity || opacity, stroke: x.color || color, strokeWidth: x.strokeWidth || strokeWidth, y1: 0, y2: height, x1: (x.strokeWidth || strokeWidth) / 2, x2: (x.strokeWidth || strokeWidth) / 2, transform: "translate(".concat(scale_1(v), ", 0)") }, "vertical-".concat(+v)));
            });
        }
        else if (x.count) {
    ...
    return jsxRuntime.jsx("g", { children: lines });
};
var index = withDisplayName('GridLines', function (_a) {
    var width = _a.width, height = _a.height, props = tslib.__rest(_a, ["width", "height"]);
    return (jsxRuntime.jsx(ScalerContext.Consumer, { children: function (_a) {
            var series = _a.series, subDomainsByItemId = _a.subDomainsByItemId;
            return (jsxRuntime.jsx(GridLines, tslib.__assign({}, props, { width: width, height: height, series: series, subDomainsByItemId: subDomainsByItemId })));
        } }));
});
...
var YAxis = function (_a) {
    ...
    var values = scale.ticks(nTicks);
    var range = scale.range().map(function (r) { return r + halfStrokeWidth; });
    var axisElement = (jsxRuntime.jsxs("g", { "data-testid": "yAxis-".concat(item.id), className: "axis y-axis", fill: "none", fontSize: tickFontSize, textAnchor: getTextAnchor({ yAxisPlacement: yAxisPlacement }), strokeWidth: strokeWidth, children: [jsxRuntime.jsx("path", { stroke: color, d: getPathString$1({
                    range: range,
                    strokeWidth: strokeWidth,
                    tickSizeOuter: tickSizeOuter,
                    width: width,
                ...
                var lineProps = tslib.__assign({ stroke: color }, getLineProps$1({
                    strokeWidth: strokeWidth,
                    tickSizeInner: tickSizeInner,
                    width: width,
                    yAxisPlacement: yAxisPlacement,
                }));
                var textProps = tslib.__assign({ fill: color, dy: '0.32em' }, getTextProps$1({
                    strokeWidth: strokeWidth,
                    tickPadding: tickPadding,
                    tickSizeInner: tickSizeInner,
                    width: width,
                ...
                return (jsxRuntime.jsxs("g", { opacity: 1, transform: "translate(0, ".concat(scale(v), ")"), children: [jsxRuntime.jsx("line", tslib.__assign({}, lineProps)), jsxRuntime.jsx("text", tslib.__assign({ className: "tick-value" }, textProps, { children: tickFormatter(+v, values) }))] }, +v));
            })] }));
    var cursor = zoomable ? 'move' : 'inherit';
    var id = collection ? collection.id : series.id;
    return (jsxRuntime.jsxs("g", { className: "axis-y axis-y-".concat(id), transform: "translate(".concat(offsetx, ", 0)"), cursor: cursor, onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave, children: [axisElement, zoomable && (jsxRuntime.jsx(ZoomRect$1, { width: width, height: height, zoomAxes: { y: true }, itemIds: [getItem(series, collection).id] }))] }));
};
YAxis.propTypes = propTypes$2;
YAxis.defaultProps = defaultProps$1;
var YAxis$1 = withDisplayName('YAxis', function (props) { return (jsxRuntime.jsx(ScalerContext.Consumer, { children: function (_a) {
        var subDomainsByItemId = _a.subDomainsByItemId;
        return (jsxRuntime.jsx(YAxis, tslib.__assign({}, props, { subDomainsByItemId: subDomainsByItemId })));
    } })); });
...
var CollapsedAxis = function (_a) {
    ...
    var renderAxis = function () {
        ...
        return (jsxRuntime.jsx("g", { className: "axis", fill: "none", fontSize: tickFontSize, textAnchor: "start", strokeWidth: strokeWidth, onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave, children: Object.keys(paths).map(function (key) { return (jsxRuntime.jsx("path", { stroke: paths[key].color, opacity: paths[key].opacity || 1, d: paths[key].path }, key)); }) }));
    };
    return (jsxRuntime.jsx("g", { className: "axis-y collapsed-axis-y", transform: "translate(".concat(initialOffsetX, ", 0)"), children: renderAxis() }));
};
...
var renderPlaceholderAxis = function (offsetx, _a) {
    ...
    if (collapsed.length) {
        return (jsxRuntime.jsx(CollapsedAxis, { height: height, offsetx: offsetx, width: yAxisWidth, onMouseEnter: onAxisMouseEnter('collapsed', { onMouseEnter: onMouseEnter }), onMouseLeave: onAxisMouseLeave('collapsed', { onMouseLeave: onMouseLeave }), yAxisPlacement: yAxisPlacement }, "y-axis--collapsed"));
    }
    return null;
};
var AxisCollection = function (_a) {
    ...
    return (jsxRuntime.jsxs("svg", { width: calculatedWidth, height: height, children: [axes, renderPlaceholderAxis(collapsedOffsetX, {
                axisDisplayMode: axisDisplayMode,
                collections: collections,
                height: height,
                onMouseEnter: onMouseEnter,
...
var AxisCollection$1 = withDisplayName('AxisCollection', function (props) { return (jsxRuntime.jsx(ScalerContext.Consumer, { children: function (_a) {
        var collections = _a.collections, series = _a.series;
        return (jsxRuntime.jsx(AxisCollection, tslib.__assign({}, props, { collections: collections, series: series })));
    } })); });

var RulerTooltip = /** @class */ (function (_super) {
    tslib.__extends(RulerTooltip, _super);
    ...
    RulerTooltip.prototype.render = function () {
        ...
        return (jsxRuntime.jsxs("g", { transform: "translate(".concat(xTranslate, ", ").concat(y, ")"), style: { cursor: 'default' }, className: "ruler-tooltip", children: [jsxRuntime.jsx("rect", { className: "ruler-tooltip-fill", fill: "white", width: textWidth + padding, height: height, stroke: color, strokeWidth: "1", strokeOpacity: "0.5", opacity: "0.9", rx: 3, ry: 3 }), jsxRuntime.jsx("text", { className: "ruler-tooltip-text", textAnchor: "middle", alignmentBaseline: "central", x: (textWidth + padding) / 2, y: height / 2, ref: this.onTooltipRef, style: {
                        fontSize: '14px',
                        color: '#333333',
                        fill: '#333333',
                    }, children: label })] }));
...
var calculateY = function (points, yTooltipPosition) {
    var pointsObject = {};
    var pointsSorted = tslib.__spreadArray([], points, true).sort(function (a, b) { return a.y - b.y; });
    var prevPoint;
...
var Ruler = function (_a) {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("line", { className: "ruler-line", y1: 0, y2: chartHeight, stroke: "#ccc", strokeWidth: "1", x1: positionX, x2: positionX }), jsxRuntime.jsx(RulerTooltip, { labelHeight: labelHeight, color: newestPoint.color, label: timeLabel(newestPoint), x: positionX, y: timeTooltipPosition, chartWidth: chartWidth }), points.map(function (point) { return [
                jsxRuntime.jsx(RulerTooltip, { labelHeight: labelHeight, color: point.color, label: yLabel(point), x: xScale(point.x), y: pointsObject[point.name] - labelHeight / 2, chartWidth: chartWidth }, point.name || point.y),
                jsxRuntime.jsx("circle", { className: "ruler-circle", r: 3, cx: xScale(point.x), cy: point.y, fill: point.color, stroke: point.color, strokeWidth: "3", strokeOpacity: "0.5" }, "circle".concat(point.name || point.y)),
            ]; })] }));
};
...
var Area = function (_a) {
    ...
    return (jsxRuntime.jsx("rect", { className: "area area-".concat(id), width: width, height: height, x: xMin, y: yMax, pointerEvents: "none", style: { stroke: color, fill: color, fillOpacity: opacity } }));
};
...
var InteractionLayer = /** @class */ (function (_super) {
    tslib.__extends(InteractionLayer, _super);
    function InteractionLayer() {
        ...
        _this.getDataForCoordinate = function (xpos, ypos, extrapolate) {
            ...
            series.forEach(function (s) {
                ...
                var rawX = d3.bisector(xAccessor).left(data, rawTimestamp, 1);
                var x0 = data[rawX - 1];
                var x1 = data[rawX];
                var d = null;
                if (x0) {
        ...
        _this.setArea = function (xpos, ypos) {
            ...
            _this.setState({
                area: tslib.__assign(tslib.__assign({}, area), { end: output }),
            });
        };
    ...
    InteractionLayer.prototype.render = function () {
        ...
        if (crosshair && x !== null && y !== null) {
            lines = (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("line", { x1: 0, x2: width, stroke: "#0004", strokeWidth: 1, y1: y, y2: y }, "x"), jsxRuntime.jsx("line", { y1: 0, y2: height, stroke: "#0004", strokeWidth: 1, x1: x, x2: x }, "y")] }));
        }
        // FIXME: Don't rely on a single time domain
        var timeSubDomain = AXES.time(subDomainsByItemId[series[0].id]);
        var xScale = createXScale(timeSubDomain, width);
        var annotations = propsAnnotations.map(function (a) { return (jsxRuntime.jsx(Annotation, tslib.__assign({}, a, { height: height, xScale: xScale }), "annotation-".concat(a.id))); });
        var areas = propsAreas.map(function (a) {
            var scaledArea = tslib.__assign({}, a);
            var s = null;
            ...
            return (jsxRuntime.jsx(Area, tslib.__assign({ color: color }, scaledArea), "area-".concat(scaledArea.id)));
        });
        var areaBeingDefined = area ? (jsxRuntime.jsx(Area, tslib.__assign({}, area, { color: "#999" }), "user")) : null;
        var zoomableAxes = zoomAxes;
        if (onAreaDefined) {
            zoomableAxes = {};
        }
        return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [lines, annotations, ruler.visible && points.length && (jsxRuntime.jsx(Ruler, { ruler: ruler, points: points, chartWidth: width, chartHeight: height })), areas, areaBeingDefined, jsxRuntime.jsx(ZoomRect$1, { zoomAxes: zoomableAxes, width: width, height: height, onClick: this.onClick, onMouseMove: this.onMouseMove, onBlur: this.onMouseMove, onMouseOut: this.onMouseOut, onMouseDown: this.onMouseDown, onMouseUp: this.onMouseUp, onDoubleClick: this.onDoubleClick, itemIds: series.map(function (s) { return s.id; }).concat(collections.map(function (c) { return c.id; })), onTouchMove: this.onTouchMove, onTouchMoveEnd: this.onTouchMoveEnd })] }));
    };
...
var InteractionLayer$1 = withDisplayName('InteractionLayer', function (props) { return (jsxRuntime.jsx(ScalerContext.Consumer, { children: function (_a) {
        var collections = _a.collections, series = _a.series, subDomainsByItemId = _a.subDomainsByItemId;
        return (jsxRuntime.jsx(InteractionLayer, tslib.__assign({}, props, { collections: collections, series: series, subDomainsByItemId: subDomainsByItemId })));
    } })); });
...
var xAxisContainer = function (area) { return function (axis, placement) { return (jsxRuntime.jsx("div", { className: "x-axis-container", style: {
        gridArea: area,
        display: 'flex',
        flexDirection: 'row',
        width: '100%',
    }, children: React__default.cloneElement(axis, { placement: placement }) }, area)); }; };
var yAxisContainer = function (area) { return function (axis, placement) { return (jsxRuntime.jsx("div", { className: "y-axis-container", style: {
        gridArea: area,
        display: 'flex',
        flexDirection: 'column',
    }, children: React__default.cloneElement(axis, { yAxisPlacement: placement }) }, area)); }; };
var XY_GRIDS = (_a = {},
...
var Layout = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", { className: "linechart-container", style: {
            display: 'grid',
            gridTemplateAreas: areas,
            gridTemplateRows: gridTemplateSpec(xAxisPlacement),
            gridTemplateColumns: gridTemplateSpec(yAxisPlacement),
            height: '100%',
        }, children: [jsxRuntime.jsx("div", { className: "lines-container", style: {
                    gridArea: 'chart',
                    display: 'flex',
                    flexDirection: 'column',
                    height: '100%',
                }, children: lineChart }), yAxes, xAxes, jsxRuntime.jsx("div", { style: { gridArea: 'spacer' } }), contextChart && (jsxRuntime.jsx("div", { className: "context-container", style: {
                    gridArea: 'context',
                    display: 'flex',
                    flexDirection: 'column',
...
var LineChart = function (_a) {
    ...
    var propsForHelpers = tslib.__assign(tslib.__assign({}, props), { contextChart: contextChart, xAxisHeight: xAxisHeight, xAxisPlacement: xAxisPlacement, yAxisDisplayMode: yAxisDisplayMode, yAxisWidth: yAxisWidth });
    ...
    return (jsxRuntime.jsx(Layout, { xAxisPlacement: xAxisPlacement, yAxisPlacement: getYAxisPlacement(propsForHelpers), lineChart: jsxRuntime.jsxs("svg", { width: chartSize.width, height: chartSize.height, children: [React__default.Children.map(children, function (child) {
                    var _a;
                    var childProps = tslib.__assign(tslib.__assign({}, chartSize), { axes: tslib.__assign(tslib.__assign({}, (child.props || {}).axes), (_a = {}, _a[AXES.x] = ((child.props || {}).axes || {}).x === undefined
                            ? String(AXES.time)
                            : child.props.axes.x, _a)) });
                    return React__default.cloneElement(child, childProps);
                }), jsxRuntime.jsx(LineCollection$1, { height: chartSize.height, width: chartSize.width, pointWidth: pointWidth }), // sizeMe can cause chartSize.width to be < 0, which causes
                // problems for the position of the ruler in InteractionLayer
                chartSize.width > 0 && (jsxRuntime.jsx(InteractionLayer$1, { height: chartSize.height, width: chartSize.width, crosshair: crosshair, onMouseMove: onMouseMove, onMouseOut: onMouseOut, onBlur: onBlur, onClickAnnotation: onClickAnnotation, onDoubleClick: onDoubleClick, ruler: ruler, annotations: annotations, onClick: onClick, areas: areas, onAreaDefined: onAreaDefined, onZoomXAxis: onZoomXAxis, onAreaClicked: onAreaClicked, zoomAxes: { time: zoomable } }))] }), yAxis: jsxRuntime.jsx(AxisCollection$1, { zoomable: zoomable, axisDisplayMode: yAxisDisplayMode, onMouseEnter: onAxisMouseEnter, onMouseLeave: onAxisMouseLeave, height: chartSize.height, tickFormatter: yAxisFormatter, yAxisWidth: yAxisWidth, ticks: yAxisTicks }), xAxis: jsxRuntime.jsx(XAxis$1, { width: chartSize.width, domain: xSubDomain, height: xAxisHeight, placement: xAxisPlacement, tickFormatter: xAxisFormatter }), contextChart: contextChart.visible && (jsxRuntime.jsx(ContextChart$1, { width: chartSize.width, height: contextChartSpace, zoomable: zoomable, annotations: annotations, xAxisFormatter: xAxisFormatter, xAxisHeight: xAxisHeight, xAxisPlacement: xAxisPlacement })) }));
};
...
var SizedLineChart = function (_a) {
    var explicitSize = _a.size, rest = tslib.__rest(_a, ["size"]);
    var _b = reactResizeDetector.useResizeDetector(), ref = _b.ref, width = _b.width, height = _b.height;
    var size = explicitSize || { width: width || 0, height: height || 0 };
    return (jsxRuntime.jsx("div", { ref: ref, style: { width: '100%', height: '100%' }, children: jsxRuntime.jsx(LineChart, tslib.__assign({}, rest, { size: size })) }));
};
...
var index$1 = withDisplayName('LineChart', function (props) { return (jsxRuntime.jsx(ScalerContext.Consumer, { children: function (_a) {
        var collections = _a.collections, series = _a.series;
        return (jsxRuntime.jsx(SizedLineChart, tslib.__assign({}, props, { collections: collections, series: series })));
    } })); });
...
var PointCollection = function (_a) {
    ...
    var points = series
        ...
        return (jsxRuntime.jsx(Points, tslib.__assign({}, s, { xScale: xScale, yScale: yScale, pointFilter: pointFilter }), s.id));
    });
    return (jsxRuntime.jsxs("g", { width: width, height: height, children: [jsxRuntime.jsx("clipPath", { id: "scatterplot-clip-path-".concat(series.map(function (s) { return s.id; }).join('-')), children: jsxRuntime.jsx("rect", { width: width, height: height, fill: "none" }) }), points] }));
};
var PointCollection$1 = withDisplayName('PointCollection', function (props) { return (jsxRuntime.jsx(ScalerContext.Consumer, { children: function (_a) {
        var subDomainsByItemId = _a.subDomainsByItemId, series = _a.series;
        return (jsxRuntime.jsx(PointCollection, tslib.__assign({}, props, { series: series, subDomainsByItemId: subDomainsByItemId })));
    } })); });
...
var xAxisContainer$1 = function (area) { return function (axis, placement) { return (jsxRuntime.jsx("div", { className: "x-axis-container", style: {
        gridArea: area,
        display: 'flex',
        flexDirection: 'row',
        width: '100%',
    }, children: React__default.cloneElement(axis, { placement: placement }) }, area)); }; };
var yAxisContainer$1 = function (area) { return function (axis, placement) { return (jsxRuntime.jsx("div", { className: "y-axis-container", style: {
        gridArea: area,
        display: 'flex',
        flexDirection: 'column',
    }, children: React__default.cloneElement(axis, { yAxisPlacement: placement }) }, area)); }; };
...
var Layout$1 = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", { className: "scatterplot-container", style: {
            display: 'grid',
            gridTemplateAreas: areas,
            gridTemplateColumns: gridTemplateSpec(yAxisPlacement),
            gridTemplateRows: gridTemplateSpec(xAxisPlacement),
            height: '100%',
        }, children: [jsxRuntime.jsx("div", { className: "chart-container", style: { gridArea: 'chart', height: '100%' }, children: chart }), yAxes, xAxes] }));
};
...
var ScatterplotComponent = function (_a) {
    ...
    var collectionVisibility = collections.reduce(function (acc, c) {
        var _a;
        return (tslib.__assign(tslib.__assign({}, acc), (_a = {}, _a[c.id] = !c.hidden && c.yAxisDisplayMode !== AXIS_DISPLAY_MODES.NONE, _a)));
    }, {});
    var seriesVisibility = series.reduce(function (acc, s) {
        var _a;
        return (tslib.__assign(tslib.__assign({}, acc), (_a = {}, _a[s.id] = 
    ...
    return (jsxRuntime.jsx(Layout$1, { chart: jsxRuntime.jsxs("svg", { style: { width: '100%', height: '100%' }, children: [React__default.Children.map(children, function (child) {
                    var _a;
                    var childProps = tslib.__assign(tslib.__assign({}, chartSize), { axes: tslib.__assign(tslib.__assign({}, (child.props || {}).axes), (_a = {}, _a[AXES.x] = ((child.props || {}).axes || {}).x === undefined
                            ? String(AXES.x)
                            : child.props.axes.x, _a)) });
                    return React__default.cloneElement(child, childProps);
                }), jsxRuntime.jsx(PointCollection$1, tslib.__assign({}, chartSize)), jsxRuntime.jsx(LineCollection$1, tslib.__assign({}, chartSize, { series: series.filter(function (s) { return !!s.drawLines; }), xAxis: AXES.x })), jsxRuntime.jsx(InteractionLayer$1, tslib.__assign({}, chartSize, { onClick: onClick, zoomMode: ZoomMode.BOTH, zoomAxes: { x: zoomable, y: zoomable } }))] }), yAxis: jsxRuntime.jsx(AxisCollection$1, { tickFormatter: yAxisFormatter, yAxisPlacement: yAxisPlacement, height: chartSize.height, yAxisWidth: yAxisWidth, ticks: yAxisTicks }), xAxis: jsxRuntime.jsx(XAxis$1, { width: chartSize.width, height: xAxisHeight, tickFormatter: xAxisFormatter, ticks: xAxisTicks, axis: AXES.x }), xAxisPlacement: xAxisPlacement, yAxisPlacement: yAxisPlacement }));
};
...
var SizedScatterplotComponent = function (_a) {
    ...
    var _b = reactResizeDetector.useResizeDetector(), ref = _b.ref, width = _b.width, height = _b.height;
    var size = explicitSize || { width: width || 0, height: height || 0 };
    return (jsxRuntime.jsx("div", { ref: ref, style: { width: '100%', height: '100%' }, children: jsxRuntime.jsx(ScatterplotComponent, tslib.__assign({}, rest, { size: size })) }));
};
...
var index$2 = withDisplayName('Scatterplot', function (props) { return (jsxRuntime.jsx(ScalerContext.Consumer, { children: function (_a) {
        var collections = _a.collections, series = _a.series;
        return (jsxRuntime.jsx(SizedScatterplotComponent, tslib.__assign({}, props, { collections: collections, series: series })));
    } })); });

exports.AxisDisplayMode = AXIS_DISPLAY_MODES;
exports.AxisPlacement = AXIS_PLACEMENTS;
exports.Brush = Brush;
exports.Collection = Collection$1;
exports.ContextChart = ContextChart$1;
exports.DataProvider = DataProvider;
exports.GridLines = index;
exports.GriffPropTypes = GriffPropTypes;
exports.Line = Line;
exports.LineChart = index$1;
exports.ScalerContext = ScalerContext;
exports.Scatterplot = index$2;
exports.Series = Series$1;
